<div class="side-container closed">
    <div class="close-button text-center text-light" style="font-size: 50px;">
        ...
        <div class="mobileMenuButtonsContainer">
            <button class="btn btn-light w-100 py-4" onclick="window.location.href='/'">Home</button>
            <button class="btn btn-light w-100 py-4" onclick="window.location.href='/order'">Order</button>
            <button class="btn btn-light w-100 py-4" onclick="window.location.href='/faq'" >F.A.Q</button>
            <button class="btn btn-light w-100 py-4" onclick="window.location.href='/contact'">Contact</button>
        </div>
    </div>
</div>
@push('scripts')
